...
function add_admin_javascript()
{
  ...
  if(is_admin()){
    ...
    wp_enqueue_style('adminNew', get_template_directory_uri() . '/assets/css/build/admin.min.css?v=' . time(), array(), THEME_VERSION, 'screen');
...
register_nav_menus(array(
  ...
  'primary-authenticated' => __('Primary Menu (Authenticated)', 'themename'),
  'footer-left' => __('Footer Left Menu', 'themename'),
  'footer-right' => __('Footer Right Menu ', 'themename'),
));
