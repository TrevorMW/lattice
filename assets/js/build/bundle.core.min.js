 ...
 */
 class AjaxFormWatcher{
    ...
    setObservers() {
        ...
        if(forms.length > 0){
            const ajaxForm = new _ajax_form__WEBPACK_IMPORTED_MODULE_0__["default"]();
            const formMsg  = new _form_message__WEBPACK_IMPORTED_MODULE_1__["default"]();
	...
	setObservers() {
		...
		if(ajaxForm.length > 0){
			...
			ajaxForm.each((idx, el) => {
				...
				if(!showProgress){
					new _progress__WEBPACK_IMPORTED_MODULE_0__["default"](this.form);
				}				
			});
		}
...
class ModalSignup {
    ...
    loadSignupModalData() {
        const self = this;
        const popup = new _core_popup__WEBPACK_IMPORTED_MODULE_0__["default"]($('[data-popup]'), 'homepage_quiz_signup', 'Sign Up to take our Quiz!');
...
/* harmony import */ var _core_cert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./core/cert */ "./assets/js/src/core/cert.js");
/* harmony import */ var _modalSignup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modalSignup */ "./assets/js/src/modalSignup.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
(() => {
	...
	$(document).ready(() => {
		...
		new _modalSignup__WEBPACK_IMPORTED_MODULE_7__["default"]();
		
		if($('[data-certificate-canvas]').length > 0){
			new _core_cert__WEBPACK_IMPORTED_MODULE_6__["default"]();
		}
	});
})();
